...
Struktur Data (List of Dictionaries) Program ini menggunakan sebuah List global bernama data_mahasiswa ([]). List ini bertindak sebagai database sementara yang menampung data. Setiap mahasiswa disimpan sebagai Dictionary di dalam List tersebut, yang memiliki pasangan key: value seperti 'nama' dan 'nilai'.

Fungsi Utama Seluruh logika program dijalankan melalui lima bagian utama:
